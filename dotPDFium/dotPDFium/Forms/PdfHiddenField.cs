...
public class PdfHiddenField : PdfFormElement
{
    internal PdfHiddenField(IntPtr annot, int annotIndex, PdfForm form, PdfPage page)
        : base(PdfFormElementType.Hidden, annot, annotIndex, form, page)
    {
    }
    ...
    {
        int flags = PdfAnnotNative.FPDFAnnot_GetFlags(_annot);
        return (flags & (int)PdfAnnotationFlags.Hidden) != 0;
    }
