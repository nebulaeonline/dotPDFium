...
public static partial class PdfEditNative
{
    ...
    public static extern bool FPDFImageObj_LoadJpegFile(IntPtr[] pages, // optional, can be null
 int count, IntPtr imageObject, ref PdfFileAccess fileAccess);
    [DllImport(PdfiumLib)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool FPDFImageObj_LoadJpegFileInline(IntPtr[] pages, int count, IntPtr imageObject, ref PdfFileAccess fileAccess);

    [DllImport(PdfiumLib)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool FPDFImageObj_SetBitmap(IntPtr[] pages, // optional, can be null
 int count, IntPtr imageObject, IntPtr bitmap);
    [DllImport(PdfiumLib)]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    public static extern void FPDFPageObj_SetBlendMode(IntPtr pageObject, [MarshalAs(UnmanagedType.LPStr)] string blendMode);
    ...
    [DllImport(PdfiumLib)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool FPDFPath_BezierTo(IntPtr path, float x1, float y1, float x2, float y2, float x3, float y3);
    [DllImport(PdfiumLib)]
    ...
    [DllImport(PdfiumLib)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool FPDFPathSegment_GetPoint(IntPtr segment, out double x, out double y);
    [DllImport(PdfiumLib)]
